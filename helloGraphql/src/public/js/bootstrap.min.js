...
!(function (e) {
  e(function () {
    ...
    e.support.transition = (function () {
      const e = (function () {
        let e = document.createElement("bootstrap"),
          t = {
  ...
  !(function (e) {
    ...
    (t.prototype.setState = function (e) {
      ...
      (t.prototype.toggle = function () {
        const e = this.$element.closest('[data-toggle="buttons-radio"]');
  ...
  !(function (e) {
    ...
    (t.prototype = {
      ...
      to: function (t) {
        let n = this.$element.find(".item.active"),
          r = n.parent().children(),
          i = r.index(n),
          s = this;
      ...
      slide: function (t, n) {
        let r = this.$element.find(".item.active"),
          i = n || r[t](),
          s = this.interval,
          o = t == "next" ? "left" : "right",
          u = t == "next" ? "first" : "last",
  ...
  !(function (e) {
    ...
    var t = "[data-toggle=dropdown]",
      n = function (t) {
        const n = e(t).on("click.dropdown.data-api", this.toggle);
    ...
    (n.prototype = {
      ...
      e(function () {
        e("html").on("click.dropdown.data-api touchstart.dropdown.data-api", r),
          e("body")
            .on(
    ...
    (t.prototype = {
      ...
      show: function () {
        ...
        e("body").addClass("modal-open"),
          ...
          this.backdrop(function () {
            const n = e.support.transition && t.$element.hasClass("fade");
      ...
      backdrop: function (t) {
        ...
        if (this.isShown && this.options.backdrop) {
          const i = e.support.transition && r;
          (this.$backdrop = e(
  ...
  !(function (e) {
    ...
    (t.prototype = {
      ...
      enter: function (t) {
        const n = e(t.currentTarget)[this.type](this._options).data(this.type);
  ...
  !(function (e) {
    "use strict";
    function t(t, n) {
      let r = e.proxy(this.process, this),
    ...
    (t.prototype = {
      ...
      process: function () {
        let e = this.$scrollElement.scrollTop() + this.options.offset,
  ...
  !(function (e) {
    ...
    (t.prototype = {
      constructor: t,
      select: function () {
        const e = this.$menu.find(".active").attr("data-value");
      ...
      show: function () {
        const t = e.extend({}, this.$element.offset(), {
          height: this.$element[0].offsetHeight,
        });
        return (
      ...
      highlighter: function (e) {
        const t = this.query.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g, "\\$&");
      ...
      next: function (t) {
        let n = this.$menu.find(".active").removeClass("active"),
          r = n.next();
        r.length || (r = e(this.$menu.find("li")[0])), r.addClass("active");
      },
      prev: function (e) {
        let t = this.$menu.find(".active").removeClass("active"),
          n = t.prev();
      ...
      listen: function () {
        this.$element
          ...
          (e.browser.chrome || e.browser.webkit || e.browser.msie) &&
