...
(function (a, b) {
  ...
  function b_(a, b, c, d) {
    if (f.isArray(b))
      ...
      for (const e in b) b_(a + "[" + e + "]", b[e], c, d);
    else d(a, b);
  }
  function b$(a, c) {
    let d,
        ...
        e.extend({
          ...
          merge: function (a, c) {
            ...
            if (typeof c.length == "number")
              for (let f = c.length; e < f; e++) a[d++] = c[e];
  ...
  (f.event = {
    ...
    dispatch: function (c) {
      ...
      let d = (f._data(this, "events") || {})[c.type] || [],
        e = d.delegateCount,
    ...
    simulate: function (a, b, c, d) {
      const e = f.extend(new f.Event(), c, {
        type: a,
        isSimulated: !0,
        originalEvent: {},
      });
    ...
    f.fn.extend({
      ...
      off: function (a, c, d) {
        ...
        if (typeof a == "object") {
          for (const g in a) this.off(g, c, a[g]);
          return this;
        }
    ...
    (function () {
      ...
      try {
        ...
        s = function (a, b) {
          ...
          if (g.call(a) === "[object Array]") Array.prototype.push.apply(d, a);
            ...
            for (let e = a.length; c < e; c++) d.push(a[c]);
        ...
        c.querySelectorAll &&
          (function () {
            ...
            if (
              ...
              for (const e in a) m[e] = a[e];
              b = null;
            }
          })(),
        (function () {
          let a = c.documentElement,
            b =
              a.matchesSelector ||
              ...
              a.msMatchesSelector;
          if (b) {
            let d = !b.call(c.createElement("div"), "div"),
              e = !1;
            try {
      ...
      var y = function (a, b, c) {
        ...
        a = o.relative[a] ? a + "*" : a;
        for (let h = 0, i = g.length; h < i; h++) m(a, g[h], e, c);
        return m.filter(f, e);
      };
      (m.attr = f.attr),
        (m.selectors.attrMap = {}),
  ...
  (bg.optgroup = bg.option),
    ...
    f.fn.extend({
      ...
      wrapAll: function (a) {
        ...
        if (this[0]) {
          const b = f(a, this[0].ownerDocument).eq(0).clone(!0);
      ...
      after: function () {
        ...
        if (arguments.length) {
          const a = this.pushStack(this, "after", arguments);
      ...
      domManip: function (a, c, d) {
        ...
        if (this[0]) {
          ...
          if (g) {
            c = c && f.nodeName(g, "tr");
            for (let l = 0, m = this.length, n = m - 1; l < m; l++)
              d.call(
        ...
        if (d) {
          ...
          for (k = 0; j[k]; k++) {
            ...
            if (e && f.nodeName(h, "script") && (!h.type || be.test(h.type)))
              ...
              if (h.nodeType === 1) {
                const v = f.grep(h.getElementsByTagName("script"), g);
  ...
  (bV = bQ.exec(bU.toLowerCase()) || []),
    ...
    f.extend({
      ...
      param: function (a, c) {
        ...
        else for (const g in a) b_(g, a[g], c, e);
  ...
  let ce = a.ActiveXObject
      ? function () {
          for (const a in cg) cg[a](0, 1);
        }
      : !1,
    cf = 0,
    cg;
